...
assert.match(compactCss, /body\[data-page="mine"\]\[data-mine-view="detail"\] \.app-bottom-chrome, body\[data-page="mine"\]\[data-mine-view="search"\] \.app-bottom-chrome, body\[data-page="mine"\]\[data-mine-view="artist"\] \.app-bottom-chrome, body\[data-page="artist"\] \.app-bottom-chrome, body\[data-page="album"\] \.app-bottom-chrome, body\[data-page="settings"\] \.app-bottom-chrome, body\[data-page="mine"\]\[data-mine-view="detail"\] \.liquid-nav-root, body\[data-page="mine"\]\[data-mine-view="search"\] \.liquid-nav-root, body\[data-page="mine"\]\[data-mine-view="artist"\] \.liquid-nav-root, body\[data-page="artist"\] \.liquid-nav-root, body\[data-page="album"\] \.liquid-nav-root, body\[data-page="settings"\] \.liquid-nav-root \{ display: none !important; \}/i, "secondary and settings pages should hide the bottom navigation");
